...
│   ├── 同步YouTube笔记.yml    # 每日 07:00 同步视频笔记
...
| Workflow | 触发方式 | 功能 |
|---------|---------|------|
| 生成课表.yml | 每天 06:00 / 手动 | 生成课表.md |
| 处理作业.yml | dispatch / 每天 22:00 | 解析作业、更新倒计时 |
| 处理调课.yml | dispatch / 手动 | 解析调课、更新数据 |
| 处理阳光长跑.yml | dispatch / 手动 | 生成热力图 |
| 同步YouTube笔记.yml | 每天 07:00 / 手动 | AI 分析视频并生成笔记 |
